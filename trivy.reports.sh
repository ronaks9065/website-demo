...
report_link="view-source-https://trivy-scan-bucket.s3.ap-south-1.amazonaws.com/$report_filename"
message="Trivy report is available at <a href=\"$report_link\">View Trivy Scan Report</a>."
