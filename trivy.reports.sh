...
aws sns publish --topic-arn "arn:aws:sns:ap-south-1:149815208654:trivy_scan_mail" --subject "Trivy Report" --message "Trivy report is available at view-source:https://trivy-scan-bucket.s3.ap-south-1.amazonaws.com/$report_filename"
