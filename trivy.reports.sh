...
message="<html><body>Trivy report is available at <a href='data:text/plain,https://trivy-scan-bucket.s3.ap-south-1.amazonaws.com/$report_filename'>View Trivy Scan Report</a></body></html>"
aws sns publish --topic-arn "arn:aws:sns:ap-south-1:149815208654:trivy_scan_mail" --subject "Trivy Report" --message "$message"
