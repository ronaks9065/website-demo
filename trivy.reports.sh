...
message="<html><body>Trivy report is available at <a href='https://trivy-scan-bucket.s3.ap-south-1.amazonaws.com/$report_filename'>View Trivy Scan Report</a></body></html>"
